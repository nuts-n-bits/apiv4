...
export class Api_request_wrapper extends jspb.Message {
  ...
  hasApplyAnonymousUser(): boolean;
  clearApplyAnonymousUser(): void;
  getApplyAnonymousUser(): include_user_pb.Request_apply_anonymous_user | undefined;
  setApplyAnonymousUser(value?: include_user_pb.Request_apply_anonymous_user): void;
...
export namespace Api_request_wrapper {
  export type AsObject = {
    ...
    applyAnonymousUser?: include_user_pb.Request_apply_anonymous_user.AsObject,
  }
...
export class Api_response_wrapper extends jspb.Message {
  ...
  hasAnonymousUserCreated(): boolean;
  clearAnonymousUserCreated(): void;
  getAnonymousUserCreated(): include_user_pb.Response_user_created | undefined;
  setAnonymousUserCreated(value?: include_user_pb.Response_user_created): void;
...
export namespace Api_response_wrapper {
  export type AsObject = {
    ...
    anonymousUserCreated?: include_user_pb.Response_user_created.AsObject,
  }
