...
export class Request_apply_anonymous_user extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): Request_apply_anonymous_user.AsObject;
  static toObject(includeInstance: boolean, msg: Request_apply_anonymous_user): Request_apply_anonymous_user.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: Request_apply_anonymous_user, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): Request_apply_anonymous_user;
  static deserializeBinaryFromReader(message: Request_apply_anonymous_user, reader: jspb.BinaryReader): Request_apply_anonymous_user;
}

export namespace Request_apply_anonymous_user {
  export type AsObject = {
  }
}
